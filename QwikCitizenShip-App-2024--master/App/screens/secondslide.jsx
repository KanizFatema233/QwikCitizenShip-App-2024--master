...
function Secondslide({navigation,route,props}) {
        ...
        <SafeAreaView style={{width:'100%',height:'100%'}}>
            ...
            <View style={[styles.MainContainer]}>
                    ...
                    <View style={{alignItems:'center',width:'100%',height:(screenHight/2) + 50,justifyContent:'flex-start'}}>
                     <Image source={require("../../assets/secondslider.png")} style={[styles.logo,{top:50}]} />
                        <View style={{top:0,justifyContent:'center',alignItems:'center'}}>
                            <View style={{marginTop:60,justifyContent:'center',alignItems:'center',width:'100%'}}>
                                <Text style={{fontWeight:'700',fontSize:25,color:'#FB3640',letterSpacing:.9,fontFamily: 'Poppins_700Bold'}}>Ad-Free Experience</Text>
                                <Text style={{fontWeight:'400',fontSize:20,color:'#FB3640',letterSpacing:.9,fontFamily: 'Poppins_400Regular'}}>No ads, just learning.</Text>
                                
                            </View>
                            <View style={{marginTop:16,justifyContent:'center',alignItems:'center',height:42}}>
                                <Text style={{fontWeight:'400',fontSize:12,color:'#3B3C36',letterSpacing:.9,fontFamily: 'Poppins_400Regular'}}>Upgrade to premium for an ad-free learning </Text>
                                <Text style={{fontWeight:'400',fontSize:12,color:'#3B3C36',top:2,letterSpacing:.9,fontFamily: 'Poppins_400Regular'}}>experience with seamless, uninterrupted usage.</Text>
                            </View>
                        </View>
                        ...
                        <View style={{width:'100%',height:150,justifyContent:'center',alignItems:'center'}}>
                            ...
                            <View style={{width:"50%",justifyContent:'center',alignItems:'center',bottom:40}}>
                                ...
                                <Svg width="73" height="15" viewBox="0 0 73 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <Circle cx="36.5" cy="7.5" r="7.5" fill="#2C3539"/>
